...
if {{verilog} eq {verilog}} {
	vlog -work work -novopt -stats=none ../../place_and_route/or_loop_post.v
} else {
	vcom -work work -2008 -novopt ../../place_and_route/or_loop_post.v
}
...
if {$mode eq {involution}} {
	...
	vsim work.circuit_TB -t fs -novopt -sdfnoerror -sdfmin c1=../../place_and_route/or_loop_altered.sdf -GVectorsDir=notUsed -GV_DD=0.80 -GV_TH=0.40
} else {
	vsim work.circuit_tb -t fs -novopt -sdfnoerror -sdfmin c1=../../place_and_route/or_loop_altered.sdf -GVectorsDir=notUsed   
}

if {$method eq {questa}} {
add wave /circuit_tb/din
add wave /circuit_tb/dout
wave add circuit_tb/c1/HT1
wave add circuit_tb/c1/OR*
wave add circuit_tb/c1/BI3
...
vcd add circuit_tb/c1/HT1
vcd add circuit_tb/c1/OR*
vcd add circuit_tb/c1/BI3
